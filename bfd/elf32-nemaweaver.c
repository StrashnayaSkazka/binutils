...
static reloc_howto_type nemaweaver_elf_howto_raw[] =
{
   ...
   HOWTO (R_NEMAWEAVER_32_PCREL,/* Type.  */
          0,			/* Rightshift.  */
          2,			/* Size (0 = byte, 1 = short, 2 = long).  */
          32,			/* Bitsize.  */
          TRUE,			/* PC_relative.  */
   ...
   HOWTO (R_NEMAWEAVER_64_PCREL,/* Type.  */
          0,			/* Rightshift.  */
          2,			/* Size (0 = byte, 1 = short, 2 = long).  */
          16,			/* Bitsize.  */
          TRUE,			/* PC_relative.  */
   ...
   HOWTO (R_NEMAWEAVER_64_NONE,	/* Type.  */
          0,			/* Rightshift.  */
          2,			/* Size (0 = byte, 1 = short, 2 = long).  */
          32,			/* Bitsize.  */
          TRUE,			/* PC_relative.  */
   ...
   HOWTO (R_NEMAWEAVER_32_SYM_OP_SYM,     	/* Type.  */
          0,			/* Rightshift.  */
          2,			/* Size (0 = byte, 1 = short, 2 = long).  */
          32,			/* Bitsize.  */
          FALSE,		/* PC_relative.  */
          ...
          complain_overflow_bitfield, /* Complain on overflow.  */
          bfd_elf_generic_reloc,/* Special Function.  */
          "R_NEMAWEAVER_32_SYM_OP_SYM",   	/* Name.  */
          FALSE,		/* Partial Inplace.  */
          0,			/* Source Mask.  */
          0xffffffff,		/* Dest Mask.  */
          FALSE), 		/* PC relative offset?  */
   ...
   HOWTO (R_NEMAWEAVER_GOTPC_64,   	/* Type.  */
          0,			/* Rightshift.  */
          2,			/* Size (0 = byte, 1 = short, 2 = long).  */
          16,			/* Bitsize.  */
          TRUE,			/* PC_relative.  */
   ...
   HOWTO (R_NEMAWEAVER_GOT_64,  /* Type.  */
          0,			/* Rightshift.  */
          2,			/* Size (0 = byte, 1 = short, 2 = long).  */
          16,			/* Bitsize.  */
          FALSE,		/* PC_relative.  */
   ...
   HOWTO (R_NEMAWEAVER_PLT_64,  /* Type.  */
          0,			/* Rightshift.  */
          2,			/* Size (0 = byte, 1 = short, 2 = long).  */
          16,			/* Bitsize.  */
          TRUE,			/* PC_relative.  */
   ...
   /*  Table-entry not really used.  */
   HOWTO (R_NEMAWEAVER_JUMP_SLOT,/* Type.  */
          0,			/* Rightshift.  */
          2,			/* Size (0 = byte, 1 = short, 2 = long).  */
          16,			/* Bitsize.  */
          TRUE,			/* PC_relative.  */
   ...
   /*  Table-entry not really used.  */
   HOWTO (R_NEMAWEAVER_GLOB_DAT,/* Type.  */
          0,			/* Rightshift.  */
          2,			/* Size (0 = byte, 1 = short, 2 = long).  */
          16,			/* Bitsize.  */
          TRUE,			/* PC_relative.  */
   ...
   HOWTO (R_NEMAWEAVER_GOTOFF_64,   	/* Type.  */
          0,			/* Rightshift.  */
          2,			/* Size (0 = byte, 1 = short, 2 = long).  */
          16,			/* Bitsize.  */
          FALSE,		/* PC_relative.  */
   ...
   HOWTO (R_NEMAWEAVER_GOTOFF_32,   	/* Type.  */
          0,			/* Rightshift.  */
          2,			/* Size (0 = byte, 1 = short, 2 = long).  */
          16,			/* Bitsize.  */
          FALSE,		/* PC_relative.  */
				  ...
				  bfd_reloc_code_real_type code)
{
  ...
  switch (code)
    ...
    case BFD_RELOC_NEMAWEAVER_64_NONE:
      nemaweaver_reloc = R_NEMAWEAVER_64_NONE;
      break;
    case BFD_RELOC_32:
    ...
    case BFD_RELOC_NEMAWEAVER_64_GOTPC:
      nemaweaver_reloc = R_NEMAWEAVER_GOTPC_64;
      break;
    case BFD_RELOC_NEMAWEAVER_64_GOT:
      nemaweaver_reloc = R_NEMAWEAVER_GOT_64;
      break;
    case BFD_RELOC_NEMAWEAVER_64_PLT:
      nemaweaver_reloc = R_NEMAWEAVER_PLT_64;
      break;
    case BFD_RELOC_NEMAWEAVER_64_GOTOFF:
      nemaweaver_reloc = R_NEMAWEAVER_GOTOFF_64;
      break;
    case BFD_RELOC_NEMAWEAVER_32_GOTOFF:
      nemaweaver_reloc = R_NEMAWEAVER_GOTOFF_32;
      break;
    case BFD_RELOC_NEMAWEAVER_COPY:
      nemaweaver_reloc = R_NEMAWEAVER_COPY;
      break;
    default:
  ...
  for (; rel < relend; rel++)
      ...
      else
	{
	  ...
	  switch ((int) r_type)
		...
		if (sec)
		  {
			...
			(*_bfd_error_handler) (_("%s: The target (%s) of an %s relocation is in the wrong section (%s)"),
					       ...
					       sym_name,
					       nemaweaver_elf_howto_table[(int) r_type]->name,
	    ...
	    case (int) R_NEMAWEAVER_32_SYM_OP_SYM:
	      break; /* Do nothing.  */

	    case (int) R_NEMAWEAVER_GOTPC_64:
			...
			if (info->shared)
			  {
			    ...
			    outrel.r_offset = (htab->sgot->output_section->vma
					       ...
					       + off);
			    outrel.r_info = ELF32_R_INFO (0, R_NEMAWEAVER_REL);
	    ...
	    case (int) R_NEMAWEAVER_GOTOFF_64:
	      {
		bfd_vma immediate;
	    ...
	    case (int) R_NEMAWEAVER_GOTOFF_32:
	      {
		relocation += addend;
		relocation -= htab->sgotplt->output_section->vma
		  + htab->sgotplt->output_offset;
	    ...
	    case (int) R_NEMAWEAVER_64_PCREL :
	    case (int) R_NEMAWEAVER_64:
	    case (int) R_NEMAWEAVER_32:
	      {
		...
		if (r_symndx == STN_UNDEF || (input_section->flags & SEC_ALLOC) == 0)
		  {
		    relocation += addend;
		    if (r_type == R_NEMAWEAVER_32)
		      bfd_put_32 (input_bfd, relocation, contents + offset);
		    else
		      {
			if (r_type == R_NEMAWEAVER_64_PCREL)
			  relocation -= (input_section->output_section->vma
					 + input_section->output_offset
					 + offset + INST_WORD_SIZE);
			bfd_put_16 (input_bfd, (relocation >> 16) & 0xffff,
...
static bfd_boolean
nemaweaver_elf_relax_section (bfd *abfd,
			      asection *sec,
			      ...
			      bfd_boolean *again)
{
  ...
  *again = FALSE;
  ...
  for (irel = internal_relocs; irel < irelend; irel++, rel_count++)
    {
      bfd_vma symval;
      if ((ELF32_R_TYPE (irel->r_info) != (int) R_NEMAWEAVER_64_PCREL)
	  && (ELF32_R_TYPE (irel->r_info) != (int) R_NEMAWEAVER_64 ))
	  ...
	  || (symval & 0xffff8000) == 0xffff8000)
	{
	  ...
	  /* Rewrite relocation type.  */
          switch ((enum elf_nemaweaver_reloc_type) ELF32_R_TYPE (irel->r_info))
	    {
	    case R_NEMAWEAVER_64_PCREL:
	      irel->r_info = ELF32_R_INFO (ELF32_R_SYM (irel->r_info),
                                           (int) R_NEMAWEAVER_32_PCREL_LO);
	      break;
	    case R_NEMAWEAVER_64:
              irel->r_info = ELF32_R_INFO (ELF32_R_SYM (irel->r_info),
                                           (int) R_NEMAWEAVER_32_LO);
	      break;
	    default:
	      /* Cannot happen.  */
	      BFD_ASSERT (FALSE);
      ...
      for (o = abfd->sections; o != NULL; o = o->next)
        {
          ...
          for (irelscan = irelocs; irelscan < irelscanend; irelscan++)
            {
              if (ELF32_R_TYPE (irelscan->r_info) == (int) R_NEMAWEAVER_32)
                {
		  ...
		  else if (ELF32_R_TYPE (irelscan->r_info) == (int) R_NEMAWEAVER_32_SYM_OP_SYM)
		    {
		      isym = isymbuf + ELF32_R_SYM (irelscan->r_info);
	      ...
	      else if ((ELF32_R_TYPE (irelscan->r_info) == (int) R_NEMAWEAVER_32_PCREL_LO)
		       || (ELF32_R_TYPE (irelscan->r_info) == (int) R_NEMAWEAVER_32_LO))
		{
		  isym = isymbuf + ELF32_R_SYM (irelscan->r_info);
	      ...
	      if (ELF32_R_TYPE (irelscan->r_info) == (int) R_NEMAWEAVER_64)
		{
		  isym = isymbuf + ELF32_R_SYM (irelscan->r_info);
	      ...
	      else if (ELF32_R_TYPE (irelscan->r_info) == (int) R_NEMAWEAVER_64_PCREL)
		{
		  isym = isymbuf + ELF32_R_SYM (irelscan->r_info);
  ...
  for (rel = relocs; rel < rel_end; rel++)
    {
	  ...
	  /* This relocation requires .got entry.  */
		...
		h->plt.refcount += 1;
		if (ELF32_R_TYPE (rel->r_info) != R_NEMAWEAVER_64_PCREL)
...
#define bfd_elf32_bfd_relax_section             nemaweaver_elf_relax_section
...
#define elf_backend_gc_sweep_hook		nemaweaver_elf_gc_sweep_hook
