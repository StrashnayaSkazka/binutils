		  ...
		  int is_rela)
{
  ...
  for (i = 0; i < rel_size; i++)
	...
	case EM_NEMAWEAVER:
	case EM_NEMAWEAVER_OLD:
	  rtype = elf_nemaweaver_reloc_type (type);
	  break;
...
get_machine_name (unsigned e_machine)
{
  ...
  switch (e_machine)
    ...
    case EM_NEMAWEAVER:		return "Think Silicon Nemaweaver";
    case EM_NEMAWEAVER_OLD:	return "Think Silicon Nemaweaver";
...
is_32bit_abs_reloc (unsigned int reloc_type)
{
  switch (elf_header.e_machine)
    ...
    case EM_NEMAWEAVER:
      return reloc_type == 1; /* R_NEMAWEAVER_32.  */
    case EM_MICROBLAZE:
...
is_32bit_pcrel_reloc (unsigned int reloc_type)
{
  switch (elf_header.e_machine)
    ...
    case EM_NEMAWEAVER:
      return reloc_type == 2;  /* R_NEMAWEAVER_32_PCREL.  */
    case EM_MICROBLAZE:
