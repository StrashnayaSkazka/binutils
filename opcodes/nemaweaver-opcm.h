...
{
//  add,rsub, addc, rsubc,
//  addk, rsubk, addkc, rsubkc, cmp, cmpu,
//  addi, rsubi, addic, rsubic, addik, rsubik, addikc, rsubikc,
//
//  mul, mulh, mulhu, mulhsu, sfork,
//
//  idiv, idivu,
...
//  muli,
//
//  bslli, bsrai, bsrli, mului, or, and, xor,
...
//  mts, mfs, br, brd,
//  brld, bra, brad, brald, sbreak, beq, beqd, bne, bned, blt,
//  bltd, ble, bled, bgt, bgtd, bge, bged, ori, andi, xori, andni,

    imm,

//  rtsd, rtid, rtbd, rted, bri, brid, brlid, brai, braid, bralid,
...
//  sbi, shi, swi,
//
//  msrset, msrclr, tuqula,
//
//  fadd, frsub, fmul, fdiv,
//
